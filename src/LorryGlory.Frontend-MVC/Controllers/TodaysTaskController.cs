    ...
    public class TodaysTaskController : Controller
    {
        ...
        public async Task<IActionResult> TaskList()
        {
            ...
            try
            {
                ...
                var staffId = User.Claims.Where(c => c.Type.ToUpper() == "NAMEID").FirstOrDefault().Value;
                ...
                // Make the API call
                var response = await client.GetAsync($"{baseUri}api/tasks/driver/{staffId}/day/{date}");
