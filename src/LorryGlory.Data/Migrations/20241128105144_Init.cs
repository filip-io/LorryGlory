        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactPerson_Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContactPerson_PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PickupAddress_AddressStreet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PickupAddress_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PickupAddress_AddressCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PickupAddress_AddressCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_AddressStreet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_AddressCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_AddressCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FK_StaffMemberId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1STAFFM", 0, "220eeee1-3f65-4871-aa45-fdbde635fa12", "magda@m.m", false, new Guid("1d2b0228-4d0d-4c23-8b49-01a698857709"), "Magda", 2, "Kubien", false, null, null, null, null, "YYYYMMDD-0000", null, false, "PL", "5dedde94-e682-437f-b1db-81054ebf2295", false, "magda@m.m", "Kato", "PL", "Vägen till ingenstans", "44444" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("9a2b0228-4d0d-4c23-8b49-01a698857709"), new DateTime(2024, 11, 28, 11, 51, 43, 914, DateTimeKind.Local).AddTicks(5526), "Test delivery task", new DateTime(2024, 11, 28, 13, 51, 43, 914, DateTimeKind.Local).AddTicks(5526), new Guid("5d2b0228-4d0d-4c23-8b49-01a698857709"), new Guid("1a2b0228-4d0d-4c23-8b49-01a698857709"), "1STAFFM", new Guid("1d2b0228-4d0d-4c23-8b49-01a698857709"), null, false, new DateTime(2024, 11, 28, 11, 51, 43, 914, DateTimeKind.Local).AddTicks(5526), 666, "Delivery Task", new DateTime(2024, 11, 28, 11, 51, 43, 914, DateTimeKind.Local).AddTicks(5526), "john@example.com", "John Doe", null, "Delivery City", "Sweden", "Delivery Street 2", "67890", "Pickup City", "Sweden", "Pickup Street 1", "12345" });
